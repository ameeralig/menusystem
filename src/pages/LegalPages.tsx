      ...
      <div className="min-h-screen w-full bg-[#FFF8F3] overflow-hidden relative">
        ...
        <div className="container mx-auto flex flex-col items-center justify-center py-6 px-4 sm:py-10 relative z-10">
          ...
          <div className="w-full max-w-4xl mb-8">
            ...
            >
              {/* أزرار التبويب */}
              <TabsList className={`grid ${isMobile ? "grid-cols-1 gap-2" : "grid-cols-3 gap-4"} w-full bg-transparent p-0 mb-8`}>
                {/* تبويب الشروط والأحكام */}
                <TabsTrigger
                  value="terms"
                  className={`flex items-center gap-2 p-4 text-center rounded-lg transition-all duration-300 
                    ${activeTab === "terms" 
