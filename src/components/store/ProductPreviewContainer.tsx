    ...
    <div className="min-h-screen flex flex-col" style={getContainerStyle()}>
      ...
      <div className={`flex-1 ${getThemeClasses(colorTheme)} transition-colors duration-300 relative`}>
        ...
        <div className={`container mx-auto py-4 sm:py-6 px-0 max-w-6xl relative ${bannerUrl && !imageError ? 'mt-[-1.5rem] sm:mt-[-2rem]' : ''}`}>
          <div className={`bg-white dark:bg-gray-800 rounded-[200px] overflow-hidden shadow-xl border border-gray-100 dark:border-gray-700 ${bannerUrl && !imageError ? 'transform-gpu' : ''}`} 
               style={{
