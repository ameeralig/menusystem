    ...
    <div className="min-h-screen flex flex-col" style={getContainerStyle()}>
      ...
      <div className={`flex-1 ${getThemeClasses(colorTheme)} transition-colors duration-300 relative`}>
        ...
        <div className="w-full relative">
          <div className={`bg-white dark:bg-gray-800 rounded-t-[2.5rem] overflow-hidden border border-gray-100 dark:border-gray-700 min-h-[100px] ${bannerUrl && !imageError ? 'mt-[-2rem]' : ''}`}>
