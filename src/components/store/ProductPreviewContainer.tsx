    ...
    <div className={`flex flex-col ${themeClasses}`} style={getContainerStyle()}>
      ...
      >
        ...
        <div className="w-full relative">
          <div className={`bg-white dark:bg-gray-800 rounded-t-[2.5rem] overflow-hidden transition-all duration-300 ${imgSrc && !imageError ? 'mt-[-1.75rem]' : ''}`} style={{ minHeight: containerHeight }}>
