...
const CategoryTabs: React.FC<CategoryTabsProps> = ({
  ...
  return (
    <>
      <div className="w-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30 overflow-visible">
