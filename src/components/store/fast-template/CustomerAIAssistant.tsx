...
const CustomerAIAssistant = ({ isOpen, onOpenChange, storeOwnerId }: CustomerAIAssistantProps) => {
  ...
  return (
    <Card className="fixed bottom-20 left-4 right-4 md:left-auto md:right-4 md:w-[400px] h-[500px] z-50 flex flex-col glass-morphism border border-white/30 shadow-2xl">
      {/* Header */}
