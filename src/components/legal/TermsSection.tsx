    ...
    >
      ...
      <div className="p-6 space-y-6 text-right">
        <div className="space-y-2">
          <h3 className="text-xl font-bold text-gray-800">1. مقدمة</h3>
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold text-gray-800">2. استخدام الخدمة</h3>
          <p className="text-gray-800 text-base leading-relaxed">
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold text-gray-800">3. الحسابات</h3>
          <p className="text-gray-800 text-base leading-relaxed">
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold text-gray-800">4. المحتوى</h3>
          <p className="text-gray-800 text-base leading-relaxed">
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold text-gray-800">5. الإلغاء والإنهاء</h3>
          <p className="text-gray-800 text-base leading-relaxed">
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold text-gray-800">6. التغييرات في الشروط</h3>
          <p className="text-gray-800 text-base leading-relaxed">
