  ...
  return (
    ...
    >
      ...
      <div className="p-2 sm:p-3 md:p-4 bg-gradient-to-l from-primary/90 to-primary text-white text-center">
        <h2 className="text-lg sm:text-xl md:text-2xl font-bold">الشروط والأحكام</h2>
      </div>

      {/* المحتوى */}
      <div className="p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4 md:space-y-6 text-right">
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">1. مقدمة</h3>
        ...
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">2. استخدام الخدمة</h3>
          <p className="text-xs sm:text-sm md:text-base text-gray-800 leading-relaxed">
        ...
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">3. الحسابات</h3>
          <p className="text-xs sm:text-sm md:text-base text-gray-800 leading-relaxed">
        ...
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">4. المحتوى</h3>
          <p className="text-xs sm:text-sm md:text-base text-gray-800 leading-relaxed">
        ...
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">5. الإلغاء والإنهاء</h3>
          <p className="text-xs sm:text-sm md:text-base text-gray-800 leading-relaxed">
        ...
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">6. التغييرات في الشروط</h3>
          <p className="text-xs sm:text-sm md:text-base text-gray-800 leading-relaxed">
