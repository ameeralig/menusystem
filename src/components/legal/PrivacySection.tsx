  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4 bg-gradient-to-l from-primary/90 to-primary text-white text-center">
        <h2 className="text-xl sm:text-2xl font-bold">سياسة الخصوصية</h2>
      </div>

      {/* المحتوى */}
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 text-right">
        <div className="space-y-2">
          <h3 className="text-lg sm:text-xl font-bold text-gray-800">1. جمع المعلومات</h3>
        ...
        <div className="space-y-2">
          <h3 className="text-lg sm:text-xl font-bold text-gray-800">2. استخدام المعلومات</h3>
          <p className="text-gray-800 text-sm sm:text-base leading-relaxed">
        ...
        <div className="space-y-2">
          <h3 className="text-lg sm:text-xl font-bold text-gray-800">3. حماية المعلومات</h3>
          <p className="text-gray-800 text-sm sm:text-base leading-relaxed">
        ...
        <div className="space-y-2">
          <h3 className="text-lg sm:text-xl font-bold text-gray-800">4. ملفات تعريف الارتباط</h3>
          <p className="text-gray-800 text-sm sm:text-base leading-relaxed">
        ...
        <div className="space-y-2">
          <h3 className="text-lg sm:text-xl font-bold text-gray-800">5. الإفصاح لأطراف ثالثة</h3>
          <p className="text-gray-800 text-sm sm:text-base leading-relaxed">
