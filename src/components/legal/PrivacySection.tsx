  ...
  return (
    ...
    >
      ...
      <div className="p-2 sm:p-3 md:p-4 bg-gradient-to-l from-primary/90 to-primary text-white text-center">
        <h2 className="text-lg sm:text-xl md:text-2xl font-bold">سياسة الخصوصية</h2>
      </div>

      {/* المحتوى */}
      <div className="p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4 md:space-y-6 text-right">
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">1. جمع المعلومات</h3>
        ...
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">2. استخدام المعلومات</h3>
          <p className="text-xs sm:text-sm md:text-base text-gray-800 leading-relaxed">
        ...
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">3. حماية المعلومات</h3>
          <p className="text-xs sm:text-sm md:text-base text-gray-800 leading-relaxed">
        ...
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">4. ملفات تعريف الارتباط</h3>
          <p className="text-xs sm:text-sm md:text-base text-gray-800 leading-relaxed">
        ...
        <div className="space-y-1 sm:space-y-2">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">5. الإفصاح لأطراف ثالثة</h3>
          <p className="text-xs sm:text-sm md:text-base text-gray-800 leading-relaxed">
