  ...
  return (
    ...
    >
      ...
      <div className="p-2 sm:p-3 bg-gradient-to-l from-primary/90 to-primary text-white text-center">
        <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold">سياسة الخصوصية</h2>
      </div>

      {/* المحتوى */}
      <div className="p-2.5 sm:p-3 md:p-4 lg:p-6 space-y-2.5 sm:space-y-3 md:space-y-4 text-right">
        <div className="space-y-1 sm:space-y-1.5">
          <h3 className="text-sm sm:text-base md:text-lg font-bold text-gray-800">1. جمع المعلومات</h3>
        ...
        <div className="space-y-1 sm:space-y-1.5">
          <h3 className="text-sm sm:text-base md:text-lg font-bold text-gray-800">2. استخدام المعلومات</h3>
          <p className="text-xs sm:text-sm text-gray-800 leading-relaxed">
        ...
        <div className="space-y-1 sm:space-y-1.5">
          <h3 className="text-sm sm:text-base md:text-lg font-bold text-gray-800">3. حماية المعلومات</h3>
          <p className="text-xs sm:text-sm text-gray-800 leading-relaxed">
        ...
        <div className="space-y-1 sm:space-y-1.5">
          <h3 className="text-sm sm:text-base md:text-lg font-bold text-gray-800">4. ملفات تعريف الارتباط</h3>
          <p className="text-xs sm:text-sm text-gray-800 leading-relaxed">
        ...
        <div className="space-y-1 sm:space-y-1.5">
          <h3 className="text-sm sm:text-base md:text-lg font-bold text-gray-800">5. الإفصاح لأطراف ثالثة</h3>
          <p className="text-xs sm:text-sm text-gray-800 leading-relaxed">
