...
import { MapPin, Phone, Wifi, Clock, ChevronDown } from "lucide-react";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
...
interface StoreFeedbackInfoProps {
  contactInfo?: ContactInfo;
  colorTheme: string | null;
}

const StoreFeedbackInfo = ({ contactInfo, colorTheme = "default" }: StoreFeedbackInfoProps) => {
  ...
  return (
    <div className="mt-4 mb-6 bg-white/10 dark:bg-black/10 backdrop-blur-md p-4 rounded-lg border border-white/20 dark:border-white/10">
      <h3 className="text-lg font-semibold mb-3 text-right">معلومات المتجر</h3>
...
export default StoreFeedbackInfo;
